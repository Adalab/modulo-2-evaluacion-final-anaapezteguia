...
function paintSearchResults() {
  let htmlCode = "";
  const defaultImg =
    "https://via.placeholder.com/210x295/dcbcc6/666666/?text=DEFAULT IMAGE";
...
function paintFavoritesList() {
  let htmlFavCode = "";
  const defaultFavImg =
    "https://via.placeholder.com/105x148/dcbcc6/666666/?text=DEFAULT IMAGE";
...
function isFavoriteSerie(serie) {
  ...
  const favorite = favoriteFound === undefined ? false : true;
  return favorite;
}
